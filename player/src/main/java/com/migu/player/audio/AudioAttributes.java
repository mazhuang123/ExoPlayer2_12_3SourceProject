 ...
 * renderers.
 *
 * <p>This class is based on {@link AudioAttributes}, but can be used on all supported
 * API versions.
 */
public final class AudioAttributes {
  ...
  public static final class Builder {
    ...
    /**
     * @see Builder#setContentType(int)
     */
  ...
  /**
   * Returns a {@link AudioAttributes} from this instance.
   *
