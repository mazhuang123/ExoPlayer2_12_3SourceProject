...
import com.migu.player.analytics.AnalyticsCollector;
import com.migu.player.analytics.AnalyticsListener;
import com.migu.player.audio.AudioAttributes;
import com.migu.player.audio.AudioListener;
import com.migu.player.audio.AudioRendererEventListener;
import com.migu.player.audio.AuxEffectInfo;
import com.migu.player.decoder.DecoderCounters;
import com.migu.player.device.DeviceInfo;
import com.migu.player.device.DeviceListener;
...
import com.migu.player.source.MediaSourceFactory;
import com.migu.player.source.ShuffleOrder;
...
import com.migu.player.upstream.DefaultBandwidthMeter;
import com.migu.player.util.Assertions;
import com.migu.player.util.Clock;
import com.migu.player.util.Log;
import com.migu.player.util.PriorityTaskManager;
import com.migu.player.util.Util;
import com.migu.player.video.VideoDecoderOutputBufferRenderer;
import com.migu.player.video.VideoFrameMetadataListener;
import com.migu.player.video.VideoRendererEventListener;
import com.migu.player.video.spherical.CameraMotionListener;
...
public class SimpleExoPlayer extends BasePlayer
  ...
  /** @deprecated Use {@link com.migu.player.video.VideoListener}. */
  @Deprecated
  public interface VideoListener extends com.migu.player.video.VideoListener {}
  ...
  private final CopyOnWriteArraySet<com.migu.player.video.VideoListener>
      videoListeners;
  ...
  @Override
  public void addVideoListener(com.migu.player.video.VideoListener listener) {
    // Don't verify application thread. We allow calls to this method from any thread.
    Assertions.checkNotNull(listener);
  ...
  @Override
  public void removeVideoListener(com.migu.player.video.VideoListener listener) {
    // Don't verify application thread. We allow calls to this method from any thread.
   ...
   * @deprecated Use {@link #addVideoListener(com.migu.player.video.VideoListener)}.
   */
  @Deprecated
  ...
  /**
   * Equivalent to {@link #removeVideoListener(com.migu.player.video.VideoListener)}.
   *
   * @param listener The listener to clear.
   * @deprecated Use {@link
   *     #removeVideoListener(com.migu.player.video.VideoListener)}.
   */
  @Deprecated
  @SuppressWarnings("deprecation")
  ...
  private void maybeNotifySurfaceSizeChanged(int width, int height) {
    if (width != surfaceWidth || height != surfaceHeight) {
      ...
      for (com.migu.player.video.VideoListener videoListener : videoListeners) {
