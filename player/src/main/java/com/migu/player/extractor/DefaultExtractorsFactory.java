 ...
 */
package com.migu.player.extractor;

import android.net.Uri;
import android.support.annotation.Nullable;

import com.migu.player.extractor.amr.AmrExtractor;
import com.migu.player.extractor.flac.FlacExtractor;
import com.migu.player.extractor.flv.FlvExtractor;
import com.migu.player.extractor.mkv.MatroskaExtractor;
import com.migu.player.extractor.mp3.Mp3Extractor;
import com.migu.player.extractor.mp4.FragmentedMp4Extractor;
import com.migu.player.extractor.mp4.Mp4Extractor;
import com.migu.player.extractor.ogg.OggExtractor;
import com.migu.player.extractor.ts.Ac3Extractor;
import com.migu.player.extractor.ts.Ac4Extractor;
import com.migu.player.extractor.ts.AdtsExtractor;
import com.migu.player.extractor.ts.DefaultTsPayloadReaderFactory;
import com.migu.player.extractor.ts.PsExtractor;
import com.migu.player.extractor.ts.TsExtractor;
import com.migu.player.extractor.ts.TsPayloadReader;
import com.migu.player.extractor.wav.WavExtractor;
import com.migu.player.util.FileTypes;
import com.migu.player.util.TimestampAdjuster;
...
import static com.migu.player.util.FileTypes.inferFileTypeFromResponseHeaders;
import static com.migu.player.util.FileTypes.inferFileTypeFromUri;
 ...
 *             com.migu.player.ext.flac.FlacExtractor} is used.
...
public final class DefaultExtractorsFactory implements ExtractorsFactory {
  ...
  static {
    ...
    try {
      ...
      boolean isFlacNativeLibraryAvailable =
          Boolean.TRUE.equals(
              Class.forName("com.migu.player.ext.flac.FlacLibrary")
                  .getMethod("isAvailable")
                  .invoke(/* obj= */ null));
      if (isFlacNativeLibraryAvailable) {
        flacExtensionExtractorConstructor =
            Class.forName("com.migu.player.ext.flac.FlacExtractor")
   ...
   * by {@code com.migu.player.ext.flac.FlacExtractor} instances if the FLAC extension
   * is being used.
   *
