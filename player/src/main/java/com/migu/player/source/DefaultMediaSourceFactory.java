...
import com.migu.player.offline.StreamKey;
import com.migu.player.source.ads.AdsLoader;
import com.migu.player.source.ads.AdsLoader.AdViewProvider;
import com.migu.player.source.ads.AdsMediaSource;
import com.migu.player.upstream.DataSource;
import com.migu.player.upstream.DataSpec;
import com.migu.player.upstream.DefaultDataSourceFactory;
 ...
 *       com.migu.player.extractor.DefaultExtractorsFactory} or the {@link
  ...
  private static SparseArray<MediaSourceFactory> loadDelegates(
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName("com.migu.player.source.dash.DashMediaSource$Factory")
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName(
                  "com.migu.player.source.smoothstreaming.SsMediaSource$Factory")
              .asSubclass(MediaSourceFactory.class);
      factories.put(
          C.TYPE_SS,
          factoryClazz.getConstructor(DataSource.Factory.class).newInstance(dataSourceFactory));
    ...
    try {
      Class<? extends MediaSourceFactory> factoryClazz =
          Class.forName("com.migu.player.source.hls.HlsMediaSource$Factory")
              .asSubclass(MediaSourceFactory.class);
      factories.put(
          C.TYPE_HLS,
          factoryClazz.getConstructor(DataSource.Factory.class).newInstance(dataSourceFactory));
