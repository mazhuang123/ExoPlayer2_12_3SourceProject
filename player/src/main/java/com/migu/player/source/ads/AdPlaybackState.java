...
public final class AdPlaybackState {
  ...
  public static final class AdGroup {
    ...
    private AdGroup(
        int count, @AdState int[] states,  Uri[] uris, long[] durationsUs) {
   ...
   * com.migu.player.Timeline.Period} they belong to. A final element with the value
   ...
   *     {@link com.migu.player.Timeline.Period} they belong to. A final element with
