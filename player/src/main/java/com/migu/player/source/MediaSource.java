...
/**
 * Defines and provides media to be played by an {@link com.migu.player.ExoPlayer}. A
 ...
 * com.migu.player.ExoPlayer} Javadoc. They should not be called directly from
 * application code. Instances can be re-used, but only for one {@link
 * com.migu.player.ExoPlayer} instance simultaneously.
 */
