...
//                    }
//                });
        sortByScore(decoderInfos, new ScoreProvider<MediaCodecInfo>() {
            @Override
            public int getScore(MediaCodecInfo mediaCodecInfo) {
                try {
...
//        Collections.sort(list, (a, b) -> scoreProvider.getScore(b) - scoreProvider.getScore(a));
        Collections.sort(list, new Comparator<T>() {
            ...
            public int compare(T t, T t1) {
                return scoreProvider.getScore(t1) - scoreProvider.getScore(t);
            }
        });
    }
