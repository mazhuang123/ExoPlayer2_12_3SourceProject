...
import com.migu.player.audio.AudioCapabilities;
import com.migu.player.audio.AudioRendererEventListener;
import com.migu.player.audio.AudioSink;
import com.migu.player.audio.DefaultAudioSink;
import com.migu.player.audio.DefaultAudioSink.DefaultAudioProcessorChain;
import com.migu.player.audio.MediaCodecAudioRenderer;
...
import com.migu.player.metadata.MetadataRenderer;
import com.migu.player.text.TextOutput;
import com.migu.player.text.TextRenderer;
import com.migu.player.trackselection.TrackSelector;
import com.migu.player.util.Log;
import com.migu.player.video.MediaCodecVideoRenderer;
import com.migu.player.video.VideoRendererEventListener;
import com.migu.player.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.migu.player.ext.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              Handler.class,
              com.migu.player.video.VideoRendererEventListener.class,
              int.class);
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.migu.player.ext.av1.Libgav1VideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              Handler.class,
  ...
  protected void buildAudioRenderers(
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.migu.player.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              Handler.class,
              AudioRendererEventListener.class,
              com.migu.player.audio.AudioSink.class);
      // LINT.ThenChange(../../../../../../../proguard-rules.txt)
      Renderer renderer =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.migu.player.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              Handler.class,
              AudioRendererEventListener.class,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("com.migu.player.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              Handler.class,
              AudioRendererEventListener.class,
