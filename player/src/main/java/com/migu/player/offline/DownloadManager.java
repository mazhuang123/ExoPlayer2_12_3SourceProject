 ...
 */
package com.migu.player.offline;
...
import com.migu.player.database.DatabaseProvider;
import com.migu.player.scheduler.Requirements;
import com.migu.player.scheduler.RequirementsWatcher;
import com.migu.player.upstream.DataSource;
import com.migu.player.upstream.DataSource.Factory;
import com.migu.player.upstream.cache.Cache;
import com.migu.player.upstream.cache.CacheDataSource;
import com.migu.player.upstream.cache.CacheEvictor;
import com.migu.player.upstream.cache.NoOpCacheEvictor;
...
import static com.migu.player.offline.Download.FAILURE_REASON_NONE;
import static com.migu.player.offline.Download.FAILURE_REASON_UNKNOWN;
import static com.migu.player.offline.Download.STATE_COMPLETED;
import static com.migu.player.offline.Download.STATE_DOWNLOADING;
import static com.migu.player.offline.Download.STATE_FAILED;
import static com.migu.player.offline.Download.STATE_QUEUED;
import static com.migu.player.offline.Download.STATE_REMOVING;
import static com.migu.player.offline.Download.STATE_RESTARTING;
import static com.migu.player.offline.Download.STATE_STOPPED;
import static com.migu.player.offline.Download.STOP_REASON_NONE;
