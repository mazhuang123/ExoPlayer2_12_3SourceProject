...
import com.migu.player.util.EGLSurfaceTexture;
import com.migu.player.util.EGLSurfaceTexture.SecureMode;
import com.migu.player.util.GlUtil;
import com.migu.player.util.Log;
import com.migu.player.util.Util;

import static com.migu.player.util.EGLSurfaceTexture.SECURE_MODE_NONE;
import static com.migu.player.util.EGLSurfaceTexture.SECURE_MODE_PROTECTED_PBUFFER;
import static com.migu.player.util.EGLSurfaceTexture.SECURE_MODE_SURFACELESS_CONTEXT;
